...
name=All Purpose SSL server cert with ML-DSA keys Profile
description=This profile creates an SSL server certificate with ML-DSA keys that is valid for SSL servers
profileIDMapping=caMLDSAServerCert
