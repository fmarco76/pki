...
public class CAApplication extends Application {
    ...
    private static String getDefaultV1ApiStatus() {
        try (InputStream is = CAApplication.class.getClassLoader().getResourceAsStream("build.properties")) {
            if (is != null) {
            ...
            logger.warn("CAApplication: Unable to read build.properties, defaulting to enabled", e);
        }
        return "enabled";
    }
    ...
    public CAApplication() {
        ...
        if ("disabled".equals(v1ApiStatus)) {
            logger.warn("======================================================================");
            logger.warn("CA v1 REST API has been DISABLED.");
